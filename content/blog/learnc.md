...
When most people describe C, they sometimes say C/++ to indicate both languages. 
...
### `sizeof` operations on expressions
...
Sometimes you need to use the name of a structure within itself; one of the most ergonomic ways I know of doing this is using both the tag name inside of a typedef itself.
